...
def main(args):
    ...
    if isinstance(deployments_root, str):
        ...
        for deployment in deployments:
            ...
            # check if binarydir, outdir, proc-logs exist
            ...
            # convert binary *.T/EBD and *.S/DBD into netcdf files.
            logging.info(
            ...
            # log how many files were successfully converted from binary to the netcdf timeseries
